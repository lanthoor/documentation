...
| --- | --- | --- |
| 2025-12-22 | Beta | [GitHub release](https://github.com/lanthoor/spendly/releases/tag/v0.8.0-beta) |

## Highlights
- Core expense and income tracking with accounts, categories, and recurring entries
- Analytics dashboard with interactive charts and period filters
- Data portability with JSON backup and restore
- Biometric app lock and theme support
